...
class Settings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SettingsCubit(SettingsRepo.getInstance())..loadSettings(),
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text(
                    ...
                    child: Row(
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: (val) {
                            context.read<SettingsCubit>().updateSettings(notifications: val);
                          },
                        ),
                      ],
                    ),
                    ...
                    child: Row(
                      children: [
                        ...
                        Checkbox(
                          ...
                          onChanged: (val) {
                            context.read<SettingsCubit>().updateSettings(cloud: val!);
                          },
                        ),
                      ],
                    ),
